...
#FUNCTIONS FOR SUBSETTING OF LANDMARKS
#function for taking the union of all the selected landmarks
#to remove repeated landmarks
...
#function for creating the landmarks list
